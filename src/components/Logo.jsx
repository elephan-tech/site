...
const Logo = ({ size, margin, children }) => {
  ...
  fill: ${({ theme, color }) => typeof theme.palette[color] === 'string' ? theme.palette[color] : theme.palette[color].main};
  box-shadow: ${({ theme, color }) => theme.palette.glow[color]};
  `;
  ...
  const ElephantechLogo = () => (
    ...
    >
      ...
      <StyledPath as='circle' color="contrast" cx="506.24" cy="247.07" r="10.06"
      />
      <StyledPath
        color='primary'
  ...
  return (<StyledLogo style={{ ...dimensions, ...style }}>{children || <ElephantechLogo />}</StyledLogo>);
};
